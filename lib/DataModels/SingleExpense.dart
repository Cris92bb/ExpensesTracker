...
class SingleExpense {
  ...
  SingleExpense.fromMap(Map<String, dynamic> map) {
    ...
    static List<SingleExpense> fromMultipleMap(List<Map<String, dynamic>> maps) {
      List<SingleExpense> expenses = []; // Already fixed in a previous step, ensure it's []
        for(var map in maps ){
        ...
        expenses.sort((a, b) {
          ...
          if (a.date == null) return -1; // Or 1, depending on how you want to sort nulls
...
String parseDate(DateTime date) { // Parameter date is non-nullable
