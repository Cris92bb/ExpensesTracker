...
class _PreferencesForm extends State<PreferencesForm> {
  ...
  void initState() {
    ...
    _prefs.then((SharedPreferences prefs) {
      ...
      totalAmmountController = TextEditingController(
        text: (prefs.getDouble('maxAmmount') ?? 0.0).toString(),
      );
      payDayController = TextEditingController(
        text: (prefs.getInt('payDay') ?? 30).toString(),
      );
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Pay Day'),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Total to spend'),
                keyboardType: TextInputType.number,
                textAlign: TextAlign.center,
              ),
              Row(
